...
const InvoicesPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("invoices")
            .find({ query: { $limit: 10000 , customerID : urlParams.singleCompaniesId ,paymentTermsID : urlParams.singlePaymentTermsId ,customerPoid : urlParams.singlePurchaseOrderId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
