...
const InvoicesPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("invoices")
            .find({ query: { $limit: 10000 , customerID : urlParams.singleCompaniesId ,paymentTermsID : urlParams.singlePaymentTermsId ,quotationID : urlParams.singleQuotationsId ,quotationItem : urlParams.singleQuotationItemsId ,customerPoid : urlParams.singlePurchaseOrderId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
