...
const InvoiceItemsPage = (props) => {
    ...
    const filename = "invoiceItems.csv";
    ...
    useEffect(() => {
        ...
        client
            ...
            .find({ query: { $limit: 10000 , invoiceId : urlParams.singleInvoicesId ,service : urlParams.singleServicesId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="invoiceItems-add-button"/>
            ...
            <div className="grid align-items-center">
                <div className="col-11" role="invoiceItems-datatable">
