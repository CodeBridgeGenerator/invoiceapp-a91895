...
const pTemplate0 = (rowData, { rowIndex }) => <p >{rowData.paymentTermID}</p>
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.name}</p>
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.description}</p>
const dropdownTemplate3 = (rowData, { rowIndex }) => <p >{rowData.invoiceID?.invoiceID}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="paymentTermID" header="Payment Term ID" body={pTemplate0} filter={selectedFilterFields.includes("paymentTermID")} hidden={selectedHideFields?.includes("paymentTermID")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="invoiceID" header="Invoice ID" body={dropdownTemplate3} filter={selectedFilterFields.includes("invoiceID")} hidden={selectedHideFields?.includes("invoiceID")}  style={{ minWidth: "8rem" }} />
