...
import seederData from "./purchaseorderItems.seeder.json";
...
const PurchaseorderItemsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PurchaseorderItemsSeederDialogComponent);
